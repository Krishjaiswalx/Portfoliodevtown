      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Enthusiastic Full Stack Web Developer with practical experience
            gained from the Sigma 4.0 course by Apna College. Skilled in
            JavaScript, React, Node.js, and MongoDB, with a solid foundation in
            Data Structures and Algorithms using Java. Developed multiple
            full-stack projects, demonstrating strong problem-solving and clean
            coding practices. Eager to contribute to innovative software
            development teams and continue growing in the tech industry.
          </p>
        </div>
        ...
        <div className="relative flex justify-center mb-16">
          ...
          <img
            src="https://www.pmindia.gov.in/en/image-gallery/"
            alt="Profile"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey with work developer in 2024 with front end
              back end.
            </p>
            <p className="text-lg text-gray-600">
